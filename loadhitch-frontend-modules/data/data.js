...
export const taxOptions = [
  ...
  { value: "Manitoba PST", label: "Manitoba PST" },
  { value: "New Brunswick HST", label: "New Brunswick HST" },
  {
    value: "Newfoundland & Labrador HST",
    label: "Newfoundland & Labrador HST",
  },
  { value: "Northwest Territories GST", label: "Northwest Territories GST" },
  { value: "Nova Scotia HST", label: "Nova Scotia HST" },
  { value: "Nunavut  GST", label: "Nunavut GST" },
  { value: "Ontario HSR", label: "Ontario HSR" },
  { value: "Prince Edward Island HST", label: "Prince Edward Island HST" },
  { value: "Quebec QST", label: "Quebec QST" },
  { value: "Saskatchewan PST", label: "Saskatchewan PST" },
  { value: "Yukon GST", label: "Yukon GST" },
];
